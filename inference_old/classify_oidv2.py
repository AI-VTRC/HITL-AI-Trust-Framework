...
--image="0000313e5dccf13b.jpg" \
--top_k=10 \
--score_threshold=0.3

python classify_oidv2.py --checkpoint_path='oidv2-resnet_v1_101.ckpt' --labelmap='classes-trainable.txt' --dict='class-descriptions.csv' --image="0000313e5dccf13b.jpg" --top_k=10 --score_threshold=0.3
