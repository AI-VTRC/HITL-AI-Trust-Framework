...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        id='json-dropdown',
        options=[{'label': json_file, 'value': json_file} for json_file in get_json_files()],
        placeholder='Select JSON File',
        value=None,
    ),

    # Reset button
    html.Button('Reset', id='reset-button', n_clicks=0, style={'marginTop': '10px', 'marginBottom': '10px'}),
